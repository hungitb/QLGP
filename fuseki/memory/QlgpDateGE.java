 ...
 * Tests if the first date argument is greater than or equal or uncompareable the date second.
 */
public class QlgpDateGE extends BaseBuiltin {
    ...
    public boolean bodyCall(Node[] args, int length, RuleContext context) {
        ...
        String s1 = (String) n1.getLiteralValue();
        String s2 = (String) n2.getLiteralValue();

        if (s1.equals("__null__") || s2.equals("__null__")) {
            return true;
        }

        int[] v1 = extractDayMonthYear(s1);
        int[] v2 = extractDayMonthYear(s2);

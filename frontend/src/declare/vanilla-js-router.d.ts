declare module '@daleighan/vanilla-js-router' {
    ...
    export default class VanillaJSRouter {
        constructor(anchorId: string, routes: { [url: string]: RouterComponent }, options?: { debug?: boolean; errorHTML?: RouterComponent; header?: RouterComponent; footer?: RouterComponent });
